...
<div class="admin-head">
  ...
  <a class="btn primary" href="education-form.php">Add Education</a>
</div>
<table class="admin-table">
  ...
  <?php foreach($items as $x): $slug=$x['slug'] ?? slugify($x['title'] ?? ''); ?>
    <tr>
      ...
      <td><?=e($x['place'] ?? '')?></td>
      <td><?=e($x['type'] ?? '')?></td>
      <td><a href="education-form.php?slug=<?=e($slug)?>">Edit</a> | <a onclick="return confirm('Delete item?')" href="education.php?delete=<?=e($slug)?>">Delete</a></td>
    </tr>
  <?php endforeach; ?>
</table>
